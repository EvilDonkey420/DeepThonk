...
if conf.games['cah']:
    ...
    @twitch_bot.command('cah', module='Games')
...
def draw_black_card():
    return black_cards[random.randrange(0, len(black_cards))]


def draw_white_card():
    return white_cards[random.randrange(0, len(white_cards))]


def play_hand():
    black = draw_black_card()
    hand = ""
    i = 0
    if len(black) == 1:
...
black_cards = [
    ...
    ('In his new summer comedy, Rob Schneider is ', ' trapped in the body of ', '.'),
    ('When I was tripping on acid, ', ' turned into ', '.'),
    ('', ' is a slippery slope that leads to ', '.'),
    ('In a world ravaged by ', ', our only solace is ', '.'),
    ("In M. Night Shyamalan's new movie, Bruce Willis discovers that ", ' had really been ', ' all along.'),
    ('I never truly understood ', ' until I encountered ', '.'),
    ("Rumor has it that Vladimir Putin's favorite dish is ", ' stuffed with ', '.'),
    ...
    ('In the new Disney Channel Original Movie, Hannah Montana struggles with ', ' for the first time.'),
    ...
    ('After Hurricane Katrina, Sean Penn brought ', ' to the people of New Orleans.'),
    ...
    ("I wish I hadn't lost the instruction manual for ", '.'),
    ...
    ('The U.S. has begun airdropping ', ' to the children of Afghanistan.'),
    ...
    ('After the earthquake, Sean Penn brought ', ' to the people of Haiti.'),
    ('Instead of coal, Santa now gives the bad children ', '.'),
    ...
    ('The socialist governments of Scandinavia have declared that access to ', ' is a basic human right.'),
    ('In his new self-produced album, Kanye West raps over the sounds of ', '.'),
    ("What's the gift that keeps on giving?",),
    ('This season on Man vs. Wild, Bear Grylls must survive in the depths of the Amazon with only ', ' and his wits. '),
    ("When I pooped, what came out of my butt?",),
    ('In the distant future, historians will agree that ', " marked the beginning of America's decline."),
